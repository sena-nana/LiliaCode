...
- [x] 统一 Lilia 工作流：界面层只暴露 Lilia 操作，内部按 Claude / Codex provider 分发。
...
- [x] Claude Lilia 工作流：支持审查、修复建议、批量应用、会话分叉和 Goal / 诊断类本地落点。
...
- [x] Codex Lilia 工作流适配：支持审查、修复建议、批量应用、压缩、会话分叉、Goal、memory、配置诊断和后台终端清理。
