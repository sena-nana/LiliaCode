...
<template>
  <component
    ...
    draggable="false"
    data-tree-kind="task"
    :data-agent-id="`sidebar.task.${task.id}`"
  ...
  >
    ...
    <div v-if="!readonly" class="sb-tree__hover-tools" @click.stop>
      <button
        ...
        :data-agent-id="`sidebar.task.merge-delete.${task.id}`"
      ...
      <button
        ...
        :data-agent-id="`sidebar.task.pin.${task.id}`"
      ...
      <button
        ...
        :data-agent-id="`sidebar.task.archive.${task.id}`"
