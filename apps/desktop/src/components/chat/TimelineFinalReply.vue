  ...
  >
    ...
    >
      <button
        ...
        :data-agent-id="`timeline.final-reply.continue.${event.id}`"
        title="从这里继续"
        aria-label="从这里继续"
      ...
      <button
        ...
        type="button"
        class="timeline-card--final-reply__action timeline-card--final-reply__action--ghost"
        :data-agent-id="`timeline.final-reply.fork.${event.id}`"
        title="从这里分叉"
        aria-label="从这里分叉"
      ...
      <button
        ...
        :data-agent-id="`timeline.final-reply.apply-suggestion.${event.id}`"
        title="应用建议"
        aria-label="应用建议"
