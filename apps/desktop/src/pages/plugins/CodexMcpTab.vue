    ...
    <ul v-if="servers.length" class="plugins-list ui-list">
      ...
      >
        <div class="plugins-list__head">
          ...
          <span class="plugins-list__badge ui-badge ui-badge--muted">
            {{ transportLabel(s) }}
          </span>
          <span v-if="!s.editable" class="plugins-list__badge ui-badge ui-badge--muted">只读</span>
        ...
        <div class="plugins-list__actions">
          ...
          <button v-else type="button" class="ui-button ui-button--ghost" @click="emit('open-config')">
